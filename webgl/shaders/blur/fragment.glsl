...
void main() {
    ...
    vec4 texel_alpha = texture2D(u_alphaTexture, texel_alpha_scaled_uv) * noise_texel;
    ...
    // if(u_alphaTexture.r)
    vec4 blured_texel = blur(u_texture, vUv, u_resolution, u_blur_direction * texel_alpha.r);
